...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="Cᴏɴᴛᴀᴄᴛ Aᴅᴍɪɴ 🚧", url="https://t.me/MrFrontMan001")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="👑 Oᴡɴᴇʀ", url="https://t.me/MrFrontMan001"),
            InlineKeyboardButton(text="Sᴜᴘᴘᴏʀᴛ 💬", url="https://t.me/WabX_Support"),
        ],
        [
            InlineKeyboardButton(text="📫 DRM", callback_data="features"),
            InlineKeyboardButton(text="CMDS 🗓️", callback_data="help_command"),
        ],
    ]
)
...
async def features_button(client, callback_query):
    ...
    f"╰━━━━━━━━✦✧✦━━━━━━━━━╯\n"
    f"╭──────────⊰◆⊱──────────╮\n"
    f" **➠ M𝗮𝗱𝗲 B𝗼𝘁𝘀 : [𓆩ཫ- FʀᴏɴᴛMᴀɴ -ཀ𓆪](https://t.me/MrFrontMan001) 🧑‍💻**\n"
    f"╰──────────⊰◆⊱──────────╯"
)
...
async def start_command(bot: Client, message: Message):
    ...
    f"┃ ✨ ɪ'ᴍ ʏᴏᴜʀ Fʀᴏɴᴛᴍᴀɴ ᴅʀᴍ ᴡɪᴢᴀʀᴅ!\n"
    f"╰━━━━━━━━━━━━━━━━━━╯\n\n"
    ...
    f"➜ `ᴄʜᴏᴏꜱᴇ ǫᴜᴀʟɪᴛʏ & ᴇɴᴊᴏʏ!`\n\n"
    f"💲 **Pricing:-**\n"
    f" <pre>**💸 ₹200 Rs. Week** for Personal Downloader</pre>\n\n"
    f"⚜️ **Pᴏᴡᴇʀᴇᴅ ʙʏ : ** [Mʀ Fʀᴏɴᴛᴍᴀɴ](https://t.me/MrFrontman001)"
)
    ...
    try:
        ...
        if message.from_user:
            ...
            if not status["is_subscribed"]:
                await message.reply_text(
                    "╭━━━━━━━━━━━━━━━━━╮\n"
                    "┣⪼𝗬𝗼𝘂 𝗔𝗿𝗲 𝗡𝗼𝘁 𝗢𝘂𝗿 𝗣𝗿𝗲𝗺𝗶𝘂𝗺 𝗦𝘂𝗯𝘀𝗰𝗿𝗶𝗯𝗲𝗿\n"
                    "╰━━━━━━━━━━━━━━━━━╯\n\n"
                    "╭─────────────────\n"
                    "┣⪼ 📍 **Cᴏɴᴛᴀᴄᴛ Aᴅᴍɪɴ**\n"
                    "┣⪼ ♣️ @MrFrontMan001\n"
...
async def txt_handler(bot: Client, m: Message):
    ...
    if raw_text3 == '1':
        CR = '[𓆩ཫ Mʀ Fʀᴏɴᴛᴍᴀɴ ཀ𓆪](https://t.me/MrFrontman001)'
    else:
        CR = raw_text3
         ...
         f'**🔱  DRM Uploder By :** {CR}'
                ...
                if "drive" in url:
                    ...
                    Show = f"╭━━━━━━━━━━━━━━━━━━━━━━━\n" \
                           ...
                           f"╰━━━━━ ✦ 🤖 BOT 𝓂𝒶𝒹𝑒 𝒷𝓎 ✦ [🂾 𓆩ཫ- FʀᴏɴᴛMᴀɴ -ཀ𓆪](https://t.me/MrFrontMan001)"
